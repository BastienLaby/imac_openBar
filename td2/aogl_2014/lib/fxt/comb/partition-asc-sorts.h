...
//#define PARTITION_ASC_SORTS_FIXARRAYS  // default off
...
private:
    ...
    {
//        cout << " :: write_s0_tail(j=" << j << ", w=" << w << ", y=" << y << ")" << endl;
...
//            if ( iq )   cout << " :: not LS: sort inversion" << endl;
//            else        cout << " :: not LS: ..." << endl;

            if ( z < 2*y1 )  // A: just increment sort
            {
//                cout << " :: not LS: A (just incr. sort)" << endl;
//                m_ = j;  // already there
                return  m_;
            }
            ...
            if ( z == 2*y1 )
            {
//                cout << " :: not LS: B (dup part and sort)" << endl;
                a_[j] = y1;
                j += 1;
                m_ = j;
                s_[j] = s1;
...
//                cout << " :: LS: A (shrink)" << endl;
            ...
            if ( z1 == y1 )
            {
//                cout << " :: LS: B (dup part and sort)" << endl;
