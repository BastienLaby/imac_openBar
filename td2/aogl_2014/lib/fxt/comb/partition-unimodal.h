#if !defined HAVE_PARTITION_UNIMODAL_H__
#define      HAVE_PARTITION_UNIMODAL_H__
...
class partition_unimodal
// Strongly unimodal partitions.
...
private:  // have pointer data
    partition_unimodal(const partition_unimodal&);  // forbidden
    partition_unimodal & operator = (const partition_unimodal&);  // forbidden

public:
    explicit partition_unimodal(ulong n)
    {
        n_ = n;
...
#endif  // !defined HAVE_PARTITION_UNIMODAL_H__
