#if !defined HAVE_PARTITION_DIST_UNIMODAL_H__
#define      HAVE_PARTITION_DIST_UNIMODAL_H__
...
#include "comb/print-partition-unimodal.h"
...
class partition_dist_unimodal
// Strongly unimodal partitions into distinct parts.
...
private:  // have pointer data
    partition_dist_unimodal(const partition_dist_unimodal&);  // forbidden
    partition_dist_unimodal & operator = (const partition_dist_unimodal&);  // forbidden

public:
    explicit partition_dist_unimodal(ulong n)
    {
        n_ = n;
    ...
    { print_partition_unimodal(bla, data(), sdata(), num_parts() ); }
};
// -------------------------


#endif  // !defined HAVE_PARTITION_DIST_UNIMODAL_H__
