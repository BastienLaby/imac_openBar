#if !defined  HAVE_CATALAN_GSLEX_H__
#define       HAVE_CATALAN_GSLEX_H__
...
private:  // have pointer data
    catalan_gslex(const catalan_gslex&);  // forbidden
    catalan_gslex & operator = (const catalan_gslex&);  // forbidden

public:
    explicit catalan_gslex(ulong n)
    {
        n_ = n;
...
//        --a_;
    ...
    // todo: *_string() duplicates functionality in paren-string-to-rgs.cc
...
#endif  // !defined HAVE_CATALAN_GSLEX_H__
