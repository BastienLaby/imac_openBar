#if !defined  HAVE_CATALAN_SUBSET_LEX_H__
#define       HAVE_CATALAN_SUBSET_LEX_H__
...
#define CATALAN_SUBSET_LEX_SC  // whether to allow n<=1
...
private:  // have pointer data
    catalan_subset_lex(const catalan_subset_lex&);  // forbidden
    catalan_subset_lex & operator = (const catalan_subset_lex&);  // forbidden

public:
    explicit catalan_subset_lex(ulong n)
    {
        n_ = n;
...
#endif  // !defined HAVE_CATALAN_SUBSET_LEX_H__
